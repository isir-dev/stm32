...
void ETH_GPIO_Config(void)
{
  ...
  GPIO_Init(GPIOA, &GPIO_InitStructure);              
	...
	//MII/RMII接口选择
#ifdef MII_MODE              //选择MII模式
 #ifdef PHY_CLOCK_MCO       //时钟信号由MCO输出引脚提供
...
#elif defined RMII_MODE  //选择RMII接口模式与PHY芯片进行通讯 

  RCC_MCO1Config(RCC_MCO1Source_PLLCLK,RCC_MCO1Div_2); //在PA8引脚上输出50MHZ时钟信号
